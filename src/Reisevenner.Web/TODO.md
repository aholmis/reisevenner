...
* Consider shorter event codes
* Ability to remove passenger
* Some kind of admin api to remove old events and other stuff
* Add logging for monitoring and statistics